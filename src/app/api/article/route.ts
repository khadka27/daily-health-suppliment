...
export async function POST(request: NextRequest) {
  try {
    ...
    // Create an object with only the fields that exist in your Prisma schema
    // Remove slug and content if they don't exist in your schema
    const articleData = {
      title,
      overview,
      description,
      ...
      productImage,
      ctaButtons,
      // REMOVE these fields if they don't exist in your schema
      // slug,
      // content: description || "",
    };
