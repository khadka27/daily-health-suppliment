      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="p-6 flex items-center group hover:bg-gray-50 transition-all duration-300">
              <div className="mr-4 text-sky-400 transform transition-transform duration-300 group-hover:scale-125">
                <FaWeight size={60} />
              </div>
