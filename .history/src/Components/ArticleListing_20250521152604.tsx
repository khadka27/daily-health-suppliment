    ...
    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 py-6 md:py-8 max-w-7xl mx-auto">
      ...
      <div className="space-y-6 sm:space-y-8">
        {articles.map((article) => (
          <div key={article.id} className="flex flex-col sm:flex-row gap-4 sm:gap-6 border-b pb-6 sm:pb-8">
            <div className="flex-shrink-0 w-full sm:w-32 md:w-40 lg:w-48 mx-auto sm:mx-0">
              <Link href={`/article/${article.slug}`} className="block">
                <div className="border p-1 sm:p-2 inline-block w-full">
                  <Image
                    src={article.imageUrl || "/placeholder.svg?height=200&width=200&query=article"}
                    alt={article.title}
                    width={200}
                    height={200}
            ...
            <div className="flex-1">
              <h2 className="text-xl sm:text-2xl font-bold mb-2">
                <Link href={`/article/${article.slug}`} className="hover:text-blue-500 transition-colors">
                  {article.title}
                </Link>
              </h2>
