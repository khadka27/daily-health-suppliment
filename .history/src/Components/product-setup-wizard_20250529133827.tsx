    ...
    headings.forEach((heading, index) => {
      const section: Block[] = [
        {
          ...
          ingredientsList: [],
          customFields: {}, // Added to satisfy Block type
        },
      ]
      ...
      if (heading === "How Does " + name + " Rate According to Our Experts?") {
        section.push({
          ...
          highlights: [
            { id: uuidv4(), text: "Made with clinically-tested, powerfully effective ingredients." },
            { id: uuidv4(), text: "Manufactured in the USA" },
            { id: uuidv4(), text: "Made in GMP-certified facilities to ensure product safety and quality" },
          ],
      ...
      // Add pros and cons section after the "Key Ingredients" heading
        ...
        section.push({
          ...
          content: "",
          pros: [
            { id: uuidv4(), text: "Clinically validated and doctor-approved" },
            { id: uuidv4(), text: "Available without a prescription" },
            { id: uuidv4(), text: "Supported by a 60-day money-back guarantee to ensure customer satisfaction" },
            { id: uuidv4(), text: "Ships with discreet packaging and secure checkout for customer privacy" },
          ],
          cons: [
            { id: uuidv4(), text: "The product is available only online and is not sold in physical stores" },
            { id: uuidv4(), text: "It may require repetition for maximum effect after 4-6 weeks" },
          ],
          ingredients: [
            { id: uuidv4(), name: "Vitamin A" },
            { id: uuidv4(), name: "Zinc" },
            { id: uuidv4(), name: "Eurycoma Longifolia" },
            { id: uuidv4(), name: "L-Arginine" },
            { id: uuidv4(), name: "Pumpkin Seed Extract" },
          ],
        })
      }
