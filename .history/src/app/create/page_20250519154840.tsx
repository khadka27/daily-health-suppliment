...
export default function CreateArticlePage() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-16 py-8 max-w-6xl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <h1 className="text-3xl font-bold text-gray-800 border-b pb-2 border-gray-200">Create Product Review</h1>
        <Button
      ...
      {isPreview ? (
        <Card className="mb-8 shadow-lg border border-gray-200">
          <CardContent className="pt-6 px-6 md:px-8">
            ...
            <div className="text-gray-600 mb-8 font-medium border-b pb-4 border-gray-100">
        ...
        >
          <div className="grid grid-cols-1 gap-8">
            <div className="space-y-2">
              <Label htmlFor="title" className="text-gray-700 font-medium text-lg font-bold">
                Title *
              </Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor="author" className="text-gray-700 font-medium text-sm">
                Author *
              </Label>
              <Input
                className="border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 rounded-md"
            ...
            <div className="space-y-2">
              <Label htmlFor="featuredImage" className="text-gray-700 font-medium text-sm">
                Featured Image
              </Label>
                ...
                {imageUrl ? (
                  ...
                  <div className="flex flex-col gap-4 p-4 border border-dashed border-gray-300 rounded-lg bg-gray-50">
                    <div className="grid grid-cols-1 gap-2">
                      <Label htmlFor="imageUpload" className="text-gray-700 font-medium text-sm">
                        Upload Image
                      </Label>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      <Label htmlFor="imageUrl" className="text-gray-700 font-medium text-sm">
                        Or Enter Image URL
                      </Label>
                      <Input
                        className="border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 rounded-md"
            ...
            <div className="bg-indigo-50 p-5 rounded-md mb-4 text-sm border-l-4 border-indigo-400">
              <p className="font-semibold text-indigo-800 mb-2">Product Review Editor Tips:</p>
            ...
            <div className="space-y-2">
              <Label className="text-gray-700 font-medium text-sm">Content *</Label>
