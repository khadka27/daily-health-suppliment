...
export async function GET(request: NextRequest) {
  try {
    ...
    const formattedArticles = articles.map((article: { id: any; title: any; slug: any; category: any; categorySlug: any; description: any; featuredImage: any; createdAt: { toISOString: () => any }; updatedAt: { toISOString: () => any } }) => ({
      id: article.id,
      title: article.title,
      slug: article.slug,
